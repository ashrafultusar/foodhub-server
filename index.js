...
async function run() {
  try {
    ...
    const reviewCollection = client.db("FoodHub").collection("reviews");
    ...
    // carts collection post or create
...
app.get("/", (req, res) => {
  res.send("FoodHub running peacefully");
});

app.listen(port, () => {
  console.log(`FoodHub is running peacefully on port ${port}`);
});
